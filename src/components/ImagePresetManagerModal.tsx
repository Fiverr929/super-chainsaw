...
export default function ImagePresetManagerModal({ onClose, onSelectDefault }: ImagePresetManagerModalProps) {
 ...
 <h2 className="text-base font-bold text-zinc-800">Listing Presets</h2>
 <button onClick={onClose} className="p-1 hover:bg-zinc-200 text-zinc-500 rounded">
 <X size={18} />
 </button>
 </div>
 ...
 <h4 className={`text-sm font-medium truncate ${editingId === preset.id && !isCreatingNew ?'text-blue-600':'text-zinc-800'}`}>
 {preset.name}
 </h4>
 </div>
 ...
 <div className="flex items-end justify-between border-b border-zinc-200 pb-0 mb-6">
 ...
 <button className="whitespace-nowrap shrink-0 pb-2 px-3 border-b-2 transition-all duration-150 border-blue-600 text-blue-600 font-bold">
 ...
 {/* Sticky Footer */}
 <div className="shrink-0 p-4 px-6 border-t border-zinc-200 bg-zinc-50 flex justify-end">
 <button 
 onClick={handleSave}
 ...
 <Star size={40} className="mb-3 text-zinc-300"/>
 <h3 className="text-base font-medium text-zinc-700 mb-1">No Preset Selected</h3>
